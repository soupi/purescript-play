...
var testCollision = function (a) {
    return function (b) {
        var $10 = a.pos.x >= b.pos.x + b.size.x || (a.pos.y >= b.pos.y + b.size.y || (a.pos.x + a.size.x <= b.pos.x || a.pos.y + a.size.y <= b.pos.y));
        if ($10) {
            return false;
        };
        if (!$10) {
        ...
        throw new Error("Failed pattern match at Collisions line 30, column 3 - line 38, column 9: " + [ $10.constructor.name ]);
    };
};
...
var addCollisions = function (v) {
    return function (v1) {
        ...
        if (v instanceof Data_Maybe.Just && v1 instanceof Data_Maybe.Just) {
            var y = (function () {
                var $19 = v.value0.y === 0.0;
                if ($19) {
                    return 0.0;
                };
                if (!$19) {
                    var $20 = v.value0.y === v1.value0.y;
                    if ($20) {
                        return v.value0.y;
                    };
                    if (!$20) {
                    ...
                    throw new Error("Failed pattern match at Collisions line 82, column 39 - line 82, column 76: " + [ $20.constructor.name ]);
                };
                throw new Error("Failed pattern match at Collisions line 82, column 11 - line 82, column 76: " + [ $19.constructor.name ]);
            })();
            var x = (function () {
                var $21 = v.value0.x === 0.0;
                if ($21) {
                    return 0.0;
                };
                if (!$21) {
                    var $22 = v.value0.x === v1.value0.x;
                    if ($22) {
                        return v.value0.x;
                    };
                    if (!$22) {
                    ...
                    throw new Error("Failed pattern match at Collisions line 81, column 39 - line 81, column 76: " + [ $22.constructor.name ]);
                };
                throw new Error("Failed pattern match at Collisions line 81, column 11 - line 81, column 76: " + [ $21.constructor.name ]);
            })();
...
var collisionDetection = function (a) {
    return function (b) {
        ...
        throw new Error("Failed pattern match at Collisions line 24, column 3 - line 24, column 64: " + [ $26.constructor.name ]);
    };
};
...
},{"../Data.Array":58,"../Data.Eq":72,"../Data.EuclideanRing":74,"../Data.Foldable":77,"../Data.Function":80,"../Data.Functor":85,"../Data.HeytingAlgebra":89,"../Data.Lens":113,"../Data.Lens.Lens":106,"../Data.Lens.Setter":110,"../Data.Maybe":118,"../Data.Ord":132,"../Data.Profunctor.Strong":139,"../Data.Ring":142,"../Data.Semiring":146,"../Data.Traversable":154,"../Prelude":170,"../Utils":180}],2:[function(require,module,exports){
// Generated by psc version 0.10.1
"use strict";
var Data_Functor = require("../Data.Functor");
